                            ...
                            <div class="container mt-4">
                                    ...
                                    <p class="status mt-4" style=" font-size:15px; color:black">
                                        ...
                                        @if ($artikel->status == 'Public')
                                            <span class="badge rounded-pill bg-primary"
                                                style="font-size:13px; position: relative; margin-left: 5px;">Public</span>
                                        @else
                                            <span class="badge rounded-pill bg-danger"
                                                style="font-size:13px; position: relative; margin-left: 5px;">Private</span>
                                        @endif
                                    </p>
                                </div>
                                <div>
                                ...
                                <div class="d-flex">
                                    ...
                                    <a role="button" style="padding: 0"
                                        onclick="handleShowLampiran('{{ $artikel->lampiran_artikel }}')"
