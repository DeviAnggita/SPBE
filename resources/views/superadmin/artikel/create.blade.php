                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-widget" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link active" href="{{ route('artikel.create') }}">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                                            fill="currentColor">
                                            <g>
                                ...
                                <form action="{{ route('artikel.store') }}" method="POST"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            name="judul_artikel" id="judul_artikel" aria-describedby="helpId"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-select mb-3 shadow-none" name="id_sub_kategori"
                                            id="id_sub_kategori" required disabled>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('lampiran_artikel') is-invalid @enderror"
                                            type="file" name="lampiran_artikel" id="lampiran_artikel" required>
                                    ...
                                    <div class="button text-end mb-3">
                                        <button type="submit" title="Tambah Artikel"
