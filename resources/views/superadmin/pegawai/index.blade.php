        ...
        <div class="sidebar-body pt-0 data-scrollbar">
            <div class="sidebar-list">
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ route('pegawai.index') }}">
                            <i class="icon">
                                <svg width="20" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body" style="color: black;">
                            <div class="form-group">
                                <label for="id_unit_create" class="form-label">OPD</label>
                                <select name="id_unit" id="id_unit_create" class="form-select mb-3 shadow-none" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('nip') is-invalid @enderror"
                                    id="nip_create" aria-describedby="nip" name="nip" value="{{ old('nip') }}"
                                    required>
                                @error('nip')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                            ...
                            <div class="form-group">
                                <label for="role_create" class="form-label">Role </label>
                                <select id="role_create" name="role" class="form-select mb-3 shadow-none" required>
            ...
            @foreach ($pegawais as $pegawai)
                <tr>
                    ...
                    <td class="d-flex">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body" style="color: black;">
                                            ...
                                            <div class="form-group d-flex align-items-baseline gap-3">
                                                ...
                                                <div>
                                                    <input type="text" class="form-control-plaintext"
                                                        style="color: black; width: 300px;" id="nama_pegawai_show"
                                                        readonly>
                                                </div>
                                            </div>
                                            <div class="form-group d-flex align-items-baseline gap-3">
                                                ...
                                                <div>
                                                    <input type="text" class="form-control-plaintext"
                                                        style="color: black; width: 300px;" id="email_pegawai_show"
                                                        readonly>
                                                </div>
                                            </div>
                                            <div class="form-group d-flex align-items-baseline gap-3">
                                                <label class="control-label mb-0" style="color: black; width: 25%;"
                                                    style="color: black;" for="role_show">Role</label>
                                                <div>:</div>
                                                <div>
                                                    <input type="text" name="role" class="form-control-plaintext"
                                                        style="color: black;" id="role_show" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="modal fade" id="deletepegawai" data-bs-backdrop="static" data-bs-keyboard="false"
            ...
            <form action="{{ route('pegawai.update', '$pegawai->id_user') }}" method="POST">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body" style="color: black;">
                            <div class="form-group">
                                <label for="id_unit_put" class="form-label">OPD</label>
                                <select name="id_unit" id="id_unit_put" class="form-select mb-3 shadow-none" required>
                                    <option disabled selected="">Pilih OPD</option>
                                    @foreach ($units as $unit)
                                        <option value="{{ $unit->id_unit }}">{{ $unit->nama_unit }}
                                        </option>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('nip') is-invalid @enderror"
                                    id="nip_put" aria-describedby="nip" name="nip" value="" required>
                                @error('nip')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('nama_pegawai') is-invalid @enderror"
                                    id="nama_pegawai_put" aria-describedby="nama_pegawai" name="nama_pegawai"
                                    value="" required>
                                @error('nama_pegawai')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control @error('email_pegawai') is-invalid @enderror"
                                    id="email_pegawai_put" aria-describedby="email_pegawai" name="email_pegawai"
                                    value="" required>
                                @error('email_pegawai')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                            ...
                            <div class="form-group">
                                <label for="role_put" class="form-label">Role</label>
                                <select name="role" id="role_put" class="form-select mb-3 shadow-none" required>
                                    <option disabled selected="">Pilih Role</option>
                                    <option value="Super Admin">Super Admin</option>
                                    <option value="Admin">Admin</option>
                                    <option value="User">User</option>
