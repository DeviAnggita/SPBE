...
<head>
    ...
    <script src="../assets/js/superadmin/opd.js"></script>
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-special" data-bs-parent="#sidebar-menu">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="{{ route('opd.index') }}">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                                            fill="currentColor">
                                            <g>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header bg-primary">
                            <h5 class="modal-title" id="staticBackdropLabel" style="color: white;">Add OPD</h5>
                        ...
                        <div class="modal-body" style="color: black;">
                            <div class="form-group">
                                ...
                                <select name="id_jenis_unit" class="form-select mb-3 shadow-none" required>
                                    <option disabled selected="">Pilih Jenis OPD</option>
                                    @foreach ($jenisunits as $jenisunit)
                                        <option value="{{ $jenisunit->id_jenis_unit }}">
                                            {{ $jenisunit->nama_jenis_unit }}
                                        </option>
                                    @endforeach
                                </select>
                                @error('id_jenis_unit')
                            ...
                            <div class="form-group">
                                <label for="nama_unit" class="form-label">Nama OPD</label>
                                <input type="text" class="form-control @error('nama_unit') is-invalid @enderror"
                                    id="nama_unit" aria-describedby="nama_unit" name="nama_unit"
                            ...
                            <div class="form-group">
                                <label for="email_unit" class="form-label">Email OPD</label>
                                <input type="email" class="form-control @error('email_unit') is-invalid @enderror"
                                    id="email_unit" aria-describedby="email_unit" name="email_unit"
                            ...
                            <div class="form-group">
                                <label for="telepon_unit" class="form-label">Telepon OPD</label>
                                <input type="number" class="form-control @error('telepon_unit') is-invalid @enderror"
                                    id="telepon_unit" aria-describedby="telepon_unit" name="telepon_unit"
                                    value="{{ old('telepon_unit') }}" required>
                                @error('telepon_unit')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group">
                                <label class="form-label" for="alamat_unit">Alamat OPD</label>
                                <textarea name="alamat_unit" class="form-control" id="alamat_unit" rows="4" required></textarea>
                                @error('alamat_unit')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
    ...
    @section('konten')
        ...
        <tbody>
            ...
            @foreach ($units as $unit)
                <tr>
                    <td class="no">{{ $no++ }}</td>
                    <td class="nama_unit">{{ $unit->nama_unit }}</td>
                    <td class="email_unit">{{ $unit->email_unit }}</td>
                    <td class="telepon_unit">{{ $unit->telepon_unit }}</td>
                    <td class="d-flex">
                        <button onclick="handleShowOPD('{{ $units }}', '{{ $unit->id_unit }}')"
                            class="btn btn-sm btn-icon text-primary flex-end" title="Detail OPD">
                        ...
                        <div class="modal fade" id="showopd" data-bs-backdrop="static" data-bs-keyboard="false"
                            tabindex="-1" aria-labelledby="showopd" aria-hidden="true">
                            <form action="{{ route('opd.update', $unit->id_unit) }}" method="post">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header bg-primary">
                                            <h5 class="modal-title" id="staticBackdropLabel" style="color: white;">Detail
                                                OPD
                                            </h5>
                                        ...
                                        <div class="modal-body" style="color: black;">
                                            <div class="form-group d-flex align-items-baseline gap-3">
                                                <label class="control-label mb-0" style="color: black; width: 25%;"
                                                    for="nama_jenis_unit_show">Jenis OPD</label>
                                                <div>:</div>
                                                <div>
                                                    <input type="text" class="form-control-plaintext"
                                                        style="color: black; width: 300px;" id="nama_jenis_unit_show"
                                                        readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group d-flex align-items-baseline gap-3">
                                                <label class="control-label mb-0" style="color: black; width: 25%;"
                                                    for="nama_unit_show">Nama OPD</label>
                                                <div>:</div>
                                                <div>
                                                    <textarea type="text" class="form-control-plaintext" style="color: black; width: 300px; resize: none;"
                                                        id="nama_unit_show" readonly></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group d-flex align-items-baseline gap-3">
                                                <label class="control-label mb-0" style="color: black; width: 25%;"
                                                    for="emailopd">Email OPD</label>
                                                <div>:</div>
                                                <div>
                                                    <input type="text" class="form-control-plaintext"
                                                        style="color: black; width: 300px;" id="email_unit_show" readonly>
                                                </div>
                                            </div>

                                            <div class="form-group d-flex align-items-baseline gap-3">
                                                <label class="control-label mb-0" style="color: black; width: 25%;"
                                                    for="telepon_unit_show">Telepon OPD</label>
                                                <div>:</div>
                                                <div>
                                                    <input type="text" class="form-control-plaintext"
                                                        style="color: black; width: 300px;" id="telepon_unit_show"
                                                        readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group d-flex align-items-baseline gap-3">
                                                <label class="control-label mb-0" style="color: black; width: 25%;"
                                                    for="alamat_unit_show">Alamat OPD</label>
                                                <div>:</div>
                                                <div>
                                                    <textarea type="text" class="form-control-plaintext" style="color: black; width: 300px; resize: none;"
                                                        id="alamat_unit_show" rows="3" readonly></textarea>
                                                </div>
                                            </div>

                                            <!-- <div class="form-group row">
                                                <label class="control-label col-sm-3 align-self-center mb-5" style="color: black;" for="alamatopd">Alamat OPD</label>
                                                <div class="col-sm-9">
                                                    <textarea type="text" class="form-control-plaintext" style="color: black;" id="alamat_unit_show" rows="3"
                                                        readonly></textarea>
                                                </div>
                                            </div> -->
                                        </div>
                        ...
                        <button onclick="handleEditOPD('{{ $units }}', '{{ $unit->id_unit }}')"
                            class="btn btn-sm btn-icon text-primary flex-end" title="Edit OPD">
                            <span class="btn-inner">
                                <svg width="20" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                        ...
                        <div class="modal fade" id="editopd" data-bs-backdrop="static" data-bs-keyboard="false"
                            tabindex="-1" aria-labelledby="editopdLabel" aria-hidden="true">
                            <form action="{{ route('opd.update', '$unit->id_unit') }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header bg-primary">
                                            <h5 class="modal-title" id="staticBackdropLabel" style="color: white;">Edit
                                                OPD</h5>
                                            <button type="button" class="btn-close btn-close-white"
                                                data-bs-dismiss="modal" aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body" style="color: black;">
                                            <div class="form-group">
                                                <label class="form-label">Jenis OPD</label>
                                                <select name="id_jenis_unit" id="id_jenis_unit_put"
                                                    class="form-select mb-3 shadow-none" required>
                                                    <option disabled selected="">Pilih Jenis OPD</option>
                                                    @foreach ($jenisunits as $jenisunit)
                                                        <option value="{{ $jenisunit->id_jenis_unit }}">
                                                            {{ $jenisunit->nama_jenis_unit }}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    id="nama_unit_put" aria-describedby="nama_unit" name="nama_unit"
                                                    value="{{ old('nama_unit') }}" required>
                                                @error('nama_unit')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                            ...
                                            <div class="form-group">
                                                <label for="email_unit" class="form-label">Email OPD</label>
                                                <input type="email"
                                                    class="form-control @error('email_unit') is-invalid @enderror"
                                                    id="email_unit_put" aria-describedby="email_unit" name="email_unit"
                                                    value="{{ old('email_unit') }}" required>
                                                @error('email_unit')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                            ...
                                            <div class="form-group">
                                                <label for="telepon_unit" class="form-label">Telepon OPD</label>
                                                <input type="number"
                                                    class="form-control @error('telepon_unit') is-invalid @enderror"
                                                    id="telepon_unit_put" aria-describedby="telepon_unit"
                                                    name="telepon_unit" value="{{ old('telepon_unit') }}" required>
                                                @error('telepon_unit')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                            ...
                                            <div class="form-group">
                                                <label class="form-label" for="exampleFormControlTextarea1">Alamat
                                                    OPD</label>
                                                <textarea name="alamat_unit" class="form-control" id="alamat_unit_put" rows="4" required></textarea>
                                                @error('alamat_unit')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                            ...
                                            <input type="hidden" name="id_unit" id="id_unit_put">
                                            <div class="text-end">
                        ...
                        <button onclick="handleDeleteOPD('{{ $unit->id_unit }}')"
                            class="btn btn-sm btn-icon text-danger flex-end" data-bs-toggle="tooltip" title="Delete OPD">
                            <span class="btn-inner">
                                <svg width="20" viewBox="0 0 24 24" fill="none"
                        ...
                        <div class="modal fade" id="deleteopd" data-bs-backdrop="static" data-bs-keyboard="false"
                            tabindex="-1" aria-labelledby="editjenisopdLabel" aria-hidden="true">
                            <form action="{{ route('opd.delete') }}" method="post">
                                @csrf
                                {{ method_field('delete') }}
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body" style="text-align: center;">
                                            <h3 class="judul mb-3">Delete OPD</h3>
                                            <input type="text"
                                                class="form-control @error('id_unit') is-invalid @enderror"
                                                id="id_unit_delete" aria-describedby="id_unit" name="id_unit" required
                                                hidden>
                        ...
                        <!-- <form action="{{ route('opd.destroy', $unit->id_unit) }}" method="post"
                            onsubmit="return confirm('Apakah anda yakin menghapus OPD <?php echo $unit->nama_unit; ?>?')">
                            @csrf
                            {{ method_field('delete') }}
                            <button type="submit" class="btn btn-sm btn-icon text-danger" data-bs-toggle="tooltip"
                                title="Delete OPD">
                                <span class="btn-inner">
