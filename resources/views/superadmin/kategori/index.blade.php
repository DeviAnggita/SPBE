...
<head>
    ...
    <script src="../assets/js/superadmin/kategori.js"></script>
...
<body class="  ">
    ...
    @section('judul_tabel', 'Kategori')
    @section('add')
        <div class="d-flex">
            <a href="#" class=" text-center btn btn-primary btn-icon mt-lg-0 mt-md-0 mt-3"
                style="position: relative; margin-right: 10px;" title="Add Kategori" data-bs-toggle="modal"
            ...
            <a href="#" class=" text-center btn btn-primary btn-icon mt-lg-0 mt-md-0 mt-3" title="Add Sub Kategori"
                data-bs-toggle="modal" data-bs-target="#subkategori">
                <i class="btn-inner">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header bg-primary">
                            <h5 class="modal-title" id="staticBackdropLabel" style="color: white">Add Kategori</h5>
                            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                                aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <div class="form-group">
                                <label for="kategori" class="form-label" style="color: black">Nama Kategori</label>
                                <input type="text" class="form-control @error('nama_kategori') is-invalid @enderror"
                                    id="kategori" aria-describedby="kategori" name="nama_kategori"
        ...
        <div class="modal fade" id="subkategori" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
            aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <form action="{{ route('subkategori.store') }}" method="POST">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header bg-primary">
                            <h5 class="modal-title" id="staticBackdropLabel" style="color: white">Add Sub Kategori</h5>
                            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                                aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <div class="form-group">
                                <label class="form-label" style="color: black">Pilih Kategori</label>
                                <select name="id_kategori" class="form-select mb-3 shadow-none" required>
                            ...
                            <div class="form-group">
                                <label for="subkategori" class="form-label" style="color: black">Nama Sub
                                    Kategori</label>
                                <input type="text"
                                    class="form-control @error('nama_sub_kategori') is-invalid @enderror" id="subkategori"
                                    aria-describedby="subkategori" name="nama_sub_kategori"
    ...
    @section('konten')
        ...
        <tbody>
            ...
            @foreach ($kategoris as $kategori)
                <tr>
                    <td class="no">{{ $no++ }}</td>
                    <td class="nama_kategori">{{ $kategori->nama_kategori }}</td>
                    <td class="d-flex">
                        <a href="{{ route('kategori.show', $kategori->id_kategori) }}" role="button"
                            class="btn btn-sm btn-icon text-primary flex-end" title="Detail Kategori">
                        ...
                        <button onclick="handleEditKategori('{{ $kategoris }}', '{{ $kategori->id_kategori }}')"
                            class="btn btn-sm btn-icon text-primary flex-end" data-bs-toggle="tooltip"
                            title="Edit Kategori">
                            <span class="btn-inner">
                                <svg width="20" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="modal fade" id="editkategori" data-bs-backdrop="static" data-bs-keyboard="false"
                            ...
                            <form action="{{ route('kategori.update', $kategori->id_kategori) }}" method="post">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group">
                                                <label for="kategori" class="form-label" style="color: black;">Nama
                                                    Kategori</label>
                                                <input type="text"
                                                    class="form-control @error('nama_kategori') is-invalid @enderror"
                                                    id="nama_kategori_put" aria-describedby="kategori"
                                                ...
                                                @enderror
                                                <input type="hidden" name="id_kategori" id="id_kategori_put">
                                            </div>
                                            <div class="text-end">
                        ...
                        <button onclick="handleDeleteKategori('{{ $kategori->id_kategori }}')"
                        ...
                        <div class="modal fade" id="deletekategori" data-bs-backdrop="static" data-bs-keyboard="false"
                            tabindex="-1" aria-labelledby="editkategoriLabel" aria-hidden="true">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body" style="text-align: center;">
                                            <h3 class="judul mb-3">Delete Kategori</h3>
                                            <input type="text"
                                                class="form-control @error('id_kategori') is-invalid @enderror"
                                                id="id_kategori_delete" aria-describedby="id_kategori" name="id_kategori"
                                                required hidden>
                    ...
                    onsubmit="return confirm('Apakah anda yakin menghapus Kategori <?php echo $kategori->nama_kategori; ?>?')">
                    @csrf
                    {{ method_field('delete') }}
