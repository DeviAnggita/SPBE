...
<head>
    ...
    <script src="../assets/js/superadmin/jenisopd.js"></script>
...
<body class="  ">
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-special" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link active" href="{{ route('jenisopd.index') }}">
                                    <i class="icon">
    ...
    @section('judul_tabel', 'Jenis OPD')
    @section('add')
        <a href="#" class=" text-center btn btn-primary btn-icon mt-lg-0 mt-md-0 mt-3 text-end"
            title="Add Jenis OPD" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
            <i class="btn-inner">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header bg-primary">
                            <h5 class="modal-title" id="staticBackdropLabel" style="color: white;">Add Jenis OPD</h5>
                            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                                aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <div class="form-group">
                                <label for="jenisopd" class="form-label" style="color: black;">Jenis OPD</label>
                                <input type="text" class="form-control @error('nama_jenis_unit') is-invalid @enderror"
                                    id="jenisunit" aria-describedby="jenisunit" name="nama_jenis_unit"
                                    value="{{ old('nama_jenis_unit') }}" required>
    ...
    @section('konten')
        ...
        <tbody>
            ...
            @foreach ($jenisunits as $jenisunit)
                <tr>
                    <td class="no">{{ $no++ }}</td>
                    <td class="nama_jenis_unit">{{ $jenisunit->nama_jenis_unit }}</td>
                    <td class="d-flex">
                        <button onclick="handleEditJenisOPD('{{ $jenisunits }}', '{{ $jenisunit->id_jenis_unit }}')"
                            class="btn btn-sm btn-icon text-primary flex-end" data-bs-toggle="tooltip"
                            title="Edit Jenis OPD">
                        ...
                        <div class="modal fade" id="editjenisopd" data-bs-backdrop="static" data-bs-keyboard="false"
                            tabindex="-1" aria-labelledby="editjenisopdLabel" aria-hidden="true">
                            <form action="{{ route('jenisopd.update', $jenisunit->id_jenis_unit) }}" method="post">
                                @csrf
                                @method('PUT')
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group">
                                                <label for="jenisopd" class="form-label" style="color: black;">Jenis
                                                    OPD</label>
                                                <input type="text"
                                                    class="form-control @error('nama_jenis_unit') is-invalid @enderror"
                                                    id="nama_jenis_unit_put" aria-describedby="jenisunit"
                                                    name="nama_jenis_unit" required>
                                                @error('nama_jenis_unit')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                                @enderror
                                                <input type="hidden" name="id_jenis_unit" id="id_jenis_unit_put">
                                            </div>
                                            <div class="text-end">
                        ...
                        <button onclick="handleDeleteJenisOPD('{{ $jenisunit->id_jenis_unit }}')"
                            class="btn btn-sm btn-icon text-danger flex-end" data-bs-toggle="tooltip"
                            title="Delete Jenis OPD">
                            <span class="btn-inner">
                                <svg width="20" viewBox="0 0 24 24" fill="none"
                        ...
                        <div class="modal fade" id="deletejenisopd" data-bs-backdrop="static" data-bs-keyboard="false"
                            tabindex="-1" aria-labelledby="editjenisopdLabel" aria-hidden="true">
                            <form action="{{ route('jenisopd.delete') }}" method="post">
                                @csrf
                                {{ method_field('delete') }}
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body" style="text-align: center;">
                                            <h3 class="judul mb-3">Delete Jenis OPD</h3>
                                            <input type="text"
                                                class="form-control @error('id_jenis_unit') is-invalid @enderror"
                                                id="id_jenis_unit_delete" aria-describedby="id_jenis_unit"
                                                name="id_jenis_unit" required hidden>
                        ...
                        <!-- <form action="{{ route('jenisopd.destroy', $jenisunit->id_jenis_unit) }}" method="post"
                        onsubmit="return confirm('Apakah anda yakin menghapus Jenis OPD <?php echo $jenisunit->nama_jenis_unit; ?>?')">
                        @csrf
                        {{ method_field('delete') }}
