        ...
        <tbody>
            ...
            @foreach ($inovasis as $inovasi)
                <tr>
                    ...
                    <td class="d-flex">
                        <a href="{{ route('inovasi.show', $inovasi->id_inovasi) }}" role="button"
                        ...
                        <a href="{{ route('inovasi.edit', $inovasi->id_inovasi) }}" role="button"
                            class="btn btn-sm btn-icon text-primary flex-end" data-bs-toggle="tooltip"
                            title="Edit Inovasi">
                            <span class="btn-inner">
                                <svg width="20" viewBox="0 0 24 24" fill="none"
                        ...
                        <div class="modal fade" id="deleteinovasi" data-bs-backdrop="static" data-bs-keyboard="false"
                            ...
                            <form action="{{ route('inovasi.delete') }}" method="post">
                                @csrf
                                {{ method_field('delete') }}
                                <div class="modal-dialog">
                                    <div class="modal-content">
