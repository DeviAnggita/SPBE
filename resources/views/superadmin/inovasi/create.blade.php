                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="utilities-error" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link active" href="{{ route('inovasi.create') }}">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                                            fill="currentColor">
                                            <g>
                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <div class="header-title">
                                <h4 class="card-title">Add Inovasi</h4>
                            </div>
                        </div>
                        <div class="card-body p-0" style="color: black;">
                            <div class="container mt-4">
                                <form action="{{ route('inovasi.store') }}" method="POST"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            name="judul_inovasi" id="judul_inovasi" aria-describedby="helpId"
                                            placeholder="">
                                        @error('judul_inovasi')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id="latarbelakanginovasi" class="form-control @error('latar_belakang') is-invalid @enderror"
                                            name="latar_belakang" id="latar_belakang" rows="3"></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id="deskripsiinovasi" class="form-control @error('deskripsi_inovasi') is-invalid @enderror"
                                            name="deskripsi_inovasi" id="deskripsi_inovasi" rows="3"></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id="tujuaninovasi" class="form-control @error('tujuan_inovasi') is-invalid @enderror" name="tujuan_inovasi"
                                            id="tujuan_inovasi" rows="3"></textarea>
