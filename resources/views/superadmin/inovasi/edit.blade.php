...
<body class="  ">
                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <div class="header-title">
                                ...
                                <h4 class="card-title mt-4">Edit Inovasi</h4>
                            </div>
                        </div>
                        <div class="card-body p-0" style="color: black;">
                            <div class="container mt-4">
                                <form action="{{ route('inovasi.update', $inovasis->id_inovasi) }}" method="POST"
                                    enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <input type="text"
                                        class="form-control @error('id_inovasi') is-invalid @enderror" id="id_inovasi"
                                        aria-describedby="id_inovasi" name="id_inovasi"
                                        value="{{ $inovasis->id_inovasi }}" required hidden>
                                    <input type="text"
                                        class="form-control @error('id_inovasi_pegawai') is-invalid @enderror"
                                        id="id_inovasi_pegawai" aria-describedby="id_inovasi_pegawai"
                                        name="id_inovasi_pegawai" value="{{ $inovasis->id_inovasi_pegawai }}"
                                        required hidden>
                                    <div class="form-group">
                                        <label style="color:black" class="form-label ">Pilih OPD</label>
                                        <select name="id_unit" id="selectOPD"
                                            class="js-example-basic-single form-select selectpicker" required>
                                            <option selected disabled>Pilih OPD</option>
                                            @foreach ($opds as $opd)
                                                <option value="{{ $opd->id_unit }}"
                                                    {{ $opd->id_unit == $inovasis->id_unit ? 'selected' : '' }}>
                                                    {{ $opd->nama_unit }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        <label style="color:black" class="form-label ">Pegawai</label>
                                        <select name="id_user" id="selectPegawai"
                                            class="js-example-basic-single form-select selectpicker" required>
                                            <option selected disabled>Pilih Pegawai</option>
                                            @foreach ($pegawais as $pegawai)
                                                <option value="{{ $pegawai->id_user }}"
                                                    {{ $pegawai->id_user == $inovasis->id_user ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group">
                                        <label class="form-label" for="">Judul Inovasi</label>
                                        <input type="text"
                                            class="form-control @error('judul_inovasi') is-invalid @enderror"
                                            name="judul_inovasi" id="judul_inovasi"
                                            value="{{ $inovasis->judul_inovasi }}" aria-describedby="helpId"
                                            placeholder="">
                                        @error('judul_inovasi')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                    ...
                                    <div class="form-group">
                                        <label class="form-label" for="">Latar Belakang</label>
                                        <textarea class="form-control @error('latar_belakang') is-invalid @enderror" name="latar_belakang"
                                            id="latarbelakanginovasi" rows="3">{{ $inovasis->latar_belakang }}</textarea>
                                    ...
                                    <div class="form-group">
                                        <label class="form-label" for="">Deskripsi Inovasi</label>
                                        <textarea class="form-control @error('deskripsi_inovasi') is-invalid @enderror" name="deskripsi_inovasi"
                                            id="deskripsiinovasi" rows="3">{{ $inovasis->deskripsi_inovasi }}</textarea>
                                    ...
                                    <div class="form-group">
                                        <label class="form-label" for="">Tujuan Inovasi</label>
                                        <textarea class="form-control @error('tujuan_inovasi') is-invalid @enderror" name="tujuan_inovasi" id="tujuaninovasi"
                                            rows="3">{{ $inovasis->tujuan_inovasi }}</textarea>
                                    ...
                                    <div class="form-group">
                                        <label class="form-label">Kategori Inovasi</label>
                                        <select name="kategori_inovasi" class="form-select mb-3 shadow-none" required>
                                            <option disabled selected="">Pilih Kategori</option>
                                            <option value="Aplikasi"
                                                {{ $inovasis->kategori_inovasi == 'Aplikasi' ? 'selected' : '' }}>
                                                Aplikasi</option>
                                            <option value="Infrastruktur"
                                                {{ $inovasis->kategori_inovasi == 'Infrastruktur' ? 'selected' : '' }}>
                                                Infrastruktur</option>
                                            <option value="Keamanan"
                                                {{ $inovasis->kategori_inovasi == 'Keamanan' ? 'selected' : '' }}>
                                                Keamanan</option>
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="datetime-local"
                                            ...
                                            name="publish_at" id="publish_at" value="{{ $inovasis->publish_at }}">
                                        @error('publish_at')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('lampiran_inovasi') is-invalid @enderror"
                                            ...
                                            value="{{ $inovasis->lampiran_inovasi }}">
                                    ...
                                    <div class="form-group">
                                        <label for="cover" class="form-label custom-file-input">Cover</label>
    ...
    <script src="../../../assets/js/superadmin/pegawai.js"></script>
