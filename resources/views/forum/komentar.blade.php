            ...
            <div class="position-breadcrumb">
                <nav aria-label="breadcrumb" class="d-inline-block">
                    <ul class="breadcrumb bg-white rounded shadow mb-0 px-4 py-2">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('forum-diskusi.show', $id) }}">Topics</a></li>
                        <li class="breadcrumb-item text-primary">Komentar</li>
                    </ul>
                </nav>
            </div>
        </div>
                ...
                <div class="col-lg-8">
                    <div class="rounded shadow">
                        ...
                        @foreach ($komentars as $komentar)
                            <div class="p-4 border-top">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="flex-1 commentor-detail">
                                            <h6 class="mb-0"><a href="javascript:void(0)"
                                                    class="media-heading text-dark">{{ $komentar->nama_pegawai }}</a>
                                            </h6>
                                ...
                                <div class="mt-3">
                                    <p class="text-muted mb-0">"{{ $komentar->komentar }}"
                                    </p>
                                </div>
                            </div>
                        @endforeach
                    ...
                    <div class="mt-4 pt-2 row">
                        <div class="rounded shadow p-4">
                            <form action="{{ route('komentar.store') }}" class="login-form" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group" hidden>
                                          ...
                                          <input type="text"
                                            class="form-control" value="{{ $id }}" name="id_topik" id="id_topik" aria-describedby="helpId" placeholder="">
