...
<body>
            ...
            <div class="row mt-5 justify-content-center">
                <div class="col-lg-12 text-center">
                    <div class="pages-heading">
                        <h4 class="title mb-0">Forum Diskusi</h4>
                    </div>
                </div>
                <!--end col-->
            </div>
            ...
            <div class="position-breadcrumb">
                <nav aria-label="breadcrumb" class="d-inline-block">
                    <ul class="breadcrumb bg-white rounded shadow mb-0 px-4 py-2">
                        ...
                        <li class="breadcrumb-item text-primary">Forums</li>
                    </ul>
                </nav>
            </div>
        </div>
    ...
    <section class="section">
        <div class="container">
            <div class="modal fade" id="addForum" tabindex="-1" aria-labelledby="LoginForm-title"
                style="display: none;" aria-modal="true" role="dialog">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content rounded shadow border-0">
                        <div class="modal-header border-bottom bg-primary">
                            <h5 class="modal-title text-light" id="LoginForm-title">Add Forum</h5>
                            <button type="button" class="btn btn-icon btn-close" data-bs-dismiss="modal"
                                id="close-modal"><i class="uil uil-times fs-4 text-light"></i></button>
                        </div>
                            ...
                            <div class="modal-body">
                                <div class="bg-white rounded box-shadow">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select mb-3 shadow-none @error('id_kategori') is-invalid @enderror" name="id_kategori"
                                    ...
                                    <div class="form-group mb-3">
                                        <label class="form-label" style="color:black" class="form-label">Sub
                                            Kategori</label>
                                        <select class="form-select mb-3 shadow-none @error('id_sub_kategori') is-invalid @enderror" name="id_sub_kategori"
                                    ...
                                    <div class="form-group mb-3">
                                        <label class="form-label" style="color:black" class="form-label">Artikel</label>
                                        <select class="form-select mb-3 shadow-none @error('id_artikel') is-invalid @enderror" name="id_artikel"
                                            id="id_artikel" required disabled>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <div class="text-center subcribe-form mb-2 d-flex">
                        <div class="col-lg-10">
                        ...
                        @if (Auth::user()->role == 'Super Admin')
                            <div class="col-lg-2">
                                <div class="text-end">
                                    <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#addForum"
                                        class="btn btn-primary m-1">Add Forum</a>
                                </div>
                            </div>
                        @endif
                    </div>
                    <div class="table-responsive bg-white shadow rounded mt-4">
                        <table class="table mb-0 table-center">
                            <thead class="bg-light">
                                <tr>
                                    <th scope="col" class="border-bottom p-3" style="max-width: 500px;">Forums
                                        Title</th>
                                    <th scope="col" class="border-bottom p-3 text-center"
                                        style="min-width: 200px;">Posted</th>
                                </tr>
                            </thead>
                                        ...
                                        <td class="p-3">
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-1 content ms-3">
                                                    <a href="{{ route('forum-diskusi.show', $forum->id_forum) }}"
                                                        class="forum-title text-primary fw-bold">{{ $forum->judul_artikel }}</a>
                                                    <p class="text-muted small mb-0 mt-1">{!! Str::substr($forum->isi_artikel, 0, 300) !!}...
                                                    </p>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="text-center small p-3 h6">{{ $forum->nama_pegawai }}</td>
                                    </tr>
                                </tbody>
                            @endforeach
                        </table>
