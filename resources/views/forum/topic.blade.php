            ...
            <div class="position-breadcrumb">
                <nav aria-label="breadcrumb" class="d-inline-block">
                    <ul class="breadcrumb bg-white rounded shadow mb-0 px-4 py-2">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('forum-diskusi.index') }}">Forums</a></li>
                        <li class="breadcrumb-item text-primary">Topics</li>
                    </ul>
                </nav>
            </div>
        </div>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content rounded shadow border-0">
                        <div class="modal-header border-bottom bg-primary">
                            <h5 class="modal-title text-light" id="LoginForm-title">Add Topic</h5>
                                ...
                                <div class="bg-white rounded box-shadow">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="judul_topik"
                                            id="judul_topik" aria-describedby="helpId"
                                            placeholder="Silahkan masukkan topic">
                                    </div>
                                    <div class="form-group" hidden>
                                        <label for="id_forum">Id Forum</label>
                                        <input type="text" class="form-control" value="{{ $id }}"
                                            name="id_forum" id="if_forum" aria-describedby="helpId"
                                            placeholder="Silahkan masukkan topic">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="text-center subcribe-form mb-2 d-flex">
                        <div class="col-lg-10">
                            <form style="max-width:800px;">
                                ...
                                <button type="submit" class="btn btn-pills btn-primary">Search Topic</button>
                            </form>
                            <!--end form-->
                        </div>
                        ...
                        <div class="col-lg-2">
                            <div class="text-end">
                                <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#addForum"
                                    class="btn btn-primary m-1">Add Topic</a>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <td class="p-3">
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-1 content ms-3">
                                                    <a href="{{ route('topic.show', $topik->id_topik) }}"
                                                        class="forum-title text-primary fw-bold">{{ $topik->judul_topik }}
                                                    </a>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="text-center small p-3 h6">{{ $topik->nama_pegawai }}</td>
