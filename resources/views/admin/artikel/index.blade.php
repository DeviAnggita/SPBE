                ...
                <tr>
                    ...
                    <td class="appproved text-center">
                        ...
                        @elseif ($artikel->approved == '-')
                            ...
                            <div class="approve">
                                <a href=" {{ route('artikeladmin.approved', $artikel->id_artikel) }} " role="button"
                        ...
                        <div class="modal fade" id="reject" data-bs-backdrop="static" data-bs-keyboard="false"
                            ...
                            <form action="{{ route('artikeladmin.reject', $artikel->id_artikel) }}" method="POST">
                                @csrf
                                @method('PUT')
                    ...
                    <td style="margin-left: auto; margin-right: auto;" class="d-flex">
                        <a role="button" class="btn btn-sm btn-icon text-primary flex-end"
                            href="{{ route('artikeladmin.show', $artikel->id_artikel) }}" title="Detail Artikel">
                            <span class="btn-inner">
                                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                        ...
                        <a role="button" class="btn btn-sm btn-icon text-primary flex-end"
                            href="{{ route('artikeladmin.edit', $artikel->id_artikel) }}" title="Edit Artikel">
                            <span class="btn-inner">
                                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                        ...
                        <div class="modal fade" id="deleteartikel" data-bs-backdrop="static" data-bs-keyboard="false"
                            ...
                            <form action="{{ route('artikeladmin.delete') }}" method="post">
                                @csrf
                                <div class="modal-dialog">
                                    <div class="modal-content">
