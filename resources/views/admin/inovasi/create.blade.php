                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="utilities-error" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link active" href="{{ route('inovasiadmin.create') }}">
                                    <i class="icon">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-0" style="color: black;">
                            <div class="container mt-4">
                                <form action="{{ route('inovasiadmin.store') }}" method="POST"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="datetime-local" class="form-control" name="publish_at" id="publish_at" value="{{ date('Y-m-d H:i:s') }}">
                                        @error('publish_at')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
