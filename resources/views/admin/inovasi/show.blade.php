                        ...
                        <div class="card-body p-0">
                            <div class="container mt-4">
                                ...
                                <div class="d-flex justify-content-between align-items-center flex-wrap">
                                    ...
                                    <div class="text-end">
                                        <a href="{{ route('membersadmin.show', $inovasi->id_inovasi) }}" class="btn btn-success btn-icon text-end" title="Members">
                                            <i class="btn-inner">
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <a href="{{ route('kegiatanadmin.add', ['id_inovasi' => $inovasi->id_inovasi]) }}" class=" text-center btn btn-primary btn-icon mt-lg-0 mt-md-0 mt-3 text-end" data-bs-toggle="tooltip" title="Add Kegiatan">
                                <i class="btn-inner">
                        ...
                        <div class="card-body mt-3">
                            ...
                            <div class="mb-2  d-flex profile-media align-items-top">
                                ...
                                <div class="ms-4">
                                    <div class="d-flex">
                                        <a href="{{ route('kegiatanadmin.show', $kegiatan->id_kegiatan) }}" role="button">
                                            <h6 class="mb-1 ">{{ $kegiatan->judul_kegiatan }}</h6>
                                        </a>
                                        <a href="{{ route('kegiatanadmin.edit', $kegiatan->id_kegiatan) }}" role="button" class="btn btn-sm btn-icon text-primary text-end" style="position: relative; margin-left: 10px" data-bs-toggle="tooltip" title="Edit Kegiatan">
                            ...
                            <div class="modal fade" id="deletekegiatan" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="editkegiatanLabel" aria-hidden="true">
                                <form action="{{ route('kegiatanadmin.delete') }}" method="post">
                                    @csrf
