                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-0" style="color: black;">
                            <div class="container mt-4">
                                <form action="{{ route('inovasiadmin.myinovasiupdate', $inovasis->id_inovasi) }}" method="POST"
                                    ...
                                    <input type="text" class="form-control @error('id_inovasi') is-invalid @enderror"
                                        ...
                                        <div class="form-group">
                                            <label style="color:black" class="form-label">Nama Author</label>
                                            <select
                                                class="form-select mb-3 shadow-none @error('id_user') is-invalid @enderror"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('latar_belakang') is-invalid @enderror"
                                            ...
                                            rows="3">{{ $inovasis->latar_belakang }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('deskripsi_inovasi') is-invalid @enderror"
                                            ...
                                            rows="3">{{ $inovasis->deskripsi_inovasi }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="datetime-local" class="form-control" name="publish_at" id="publish_at" value="{{ $inovasis->publish_at }}">
                                        @error('publish_at')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
