...
<body class="  ">
    ...
    @section('judul_tabel', 'List Inovasi')
    {{-- @section('add')
    ...
    <tbody>
        ...
        <tr>
            <td class="no">{{ $no++ }}</td>
            <td class="judul_inovasi">{{ $inovasi->judul_inovasi }}</td>
            <td class="nama_opd">{{ $inovasi->nama_unit }}</td>
            <td class="nama_pegawai">{{ $inovasi->keterangan }}</td>
            <td class="d-flex">
                <a href="{{ route('inovasiadmin.myinovasishow', $inovasi->id_inovasi) }}" role="button"
                    class="btn btn-sm btn-icon text-primary flex-end" data-bs-toggle="tooltip" title="Detail Inovasi">
                ...
                <a href="{{ route('inovasiadmin.myinovasiedit',$inovasi->id_inovasi) }}" role="button"
                    class="btn btn-sm btn-icon text-primary flex-end" data-bs-toggle="tooltip" title="Edit Inovasi">
                    <span class="btn-inner">
                        <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                ...
                <button onclick="handleDeleteInovasi('{{ $inovasi->id_inovasi }}')"
                    class="btn btn-sm btn-icon text-danger flex-end" data-bs-toggle="tooltip" title="Delete Inovasi">
                    <span class="btn-inner">
                        <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                            stroke="currentColor">
                            <path
                ...
                <div class="modal fade" id="deleteinovasi" data-bs-backdrop="static" data-bs-keyboard="false"
                    tabindex="-1" aria-labelledby="editinovasiLabel" aria-hidden="true">
                    <form action="{{ route('inovasiadmin.myinovasidelete') }}" method="post">
                        @csrf
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-body" style="text-align: center;">
                                    ...
                                    <input type="text" class="form-control @error('id_inovasi') is-invalid @enderror"
                                        id="id_inovasi_delete" aria-describedby="id_inovasi" name="id_inovasi"
                                        required hidden>
                ...
                {{-- <form action="{{ route('inovasi.destroy', $inovasi->id_inovasi) }}" method="post"
                    onsubmit="return confirm('Apakah anda yakin menghapus data inovasi <?php echo $inovasi->judul_inovasi; ?>?')">
                    @csrf
                    {{ method_field('delete') }}
