...
<body class="  ">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="nama_pegawai">{{ $inovasi->nama_pegawai }}</td>
            <td class="d-flex">
                <a href="{{ route('inovasiadmin.show', $inovasi->id_inovasi) }}" role="button"
                ...
                <a href="{{ route('inovasiadmin.edit',$inovasi->id_inovasi) }}" role="button"
                ...
                <div class="modal fade" id="deleteinovasi" data-bs-backdrop="static" data-bs-keyboard="false"
                    ...
                    <form action="{{ route('inovasiadmin.delete') }}" method="post">
                        @csrf
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
