...
<body>
            ...
            <div class="row justify-content-center" style="position: relative; top: 2cm">
                <div class="col-md-10">
                    <div class="text-center subcribe-form">
                        <form style="max-width: 800px;" action="{{ route('search.artikel') }}" method="GET">
                            <div class="mb-0">
            ...
            <div class="position-breadcrumb">
                <nav aria-label="breadcrumb" class="d-inline-block">
                    <ul class="breadcrumb bg-white rounded shadow mb-0 px-4 py-2">
                        ...
                        <li class="breadcrumb-item text-primary">Artikel</li>
                    </ul>
                </nav>
            </div>
        </div>
    ...
    @if (Auth::check() == true)
        <section class="section">
            <div class="container">
                <div class="row">
                    <div class="text-end">
                        <a href="{{ route('artikeluser.create') }}" class="btn btn-primary">Add Artikel</a>
                    </div>
                </div>
                    ...
                    <div class="col-12 filters-group-wrap">
                        <div class="filters-group">
                            <ul class="container-filter list-inline mb-0 filter-options text-center">
                                <li onclick="handleAddHidden()" class="list-inline-item categories-name border text-dark rounded active"
                                    data-group="all">All</li>
                                <li onclick="handleRemoveHidden()" class="list-inline-item categories-name border text-dark rounded"
                                    data-group="{{ Auth::user()->id_user }}">My Artikel</li>
                            </ul>
                        </div>
                    </div>
                    <!--end col-->
                ...
                <div id="grid" class="row">
                    @foreach ($artikels_all as $artikel)
                        <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2 picture-item"
                            data-groups='["{{ $artikel->id_user }}"]'>
                            <div
                                ...
                                <div class="card-body" style="height: 3.5cm">
                                    <div class="content">
                                        <h6 class="kategori text-primary">{{ $artikel->nama_kategori }}</h6>
                                        <h5><a href="{{ route('artikeluser.show', $artikel->id_artikel) }}"
                        ...
                        <!--end col-->
                    @endforeach
                    @foreach ($artikels_no as $artikel)
                        <div class="myartikel-no col-lg-4 col-md-6 col-12 mt-4 pt-2 picture-item"
                            data-groups='["{{ $artikel->id_user }}"]' hidden>
                            <div
                                class="card blog border-0 work-container work-primary work-classic shadow rounded-md overflow-hidden">
                                <div class="position-relative">
                                    <img src="assets/cover/{{ $artikel->cover }}" class="card-img-top rounded-top"
                                ...
                                <div class="author">
                                    <small class="badge badge-link bg-danger">Rejected</small>
                                    <small class="text-light user d-block"><i class="uil uil-user"></i>
                                        {{ $artikel->nama_pegawai }}</small>
                                    <small class="text-light date"><i class="uil uil-calendar-alt"></i>
                                        {{ $artikel->publish_at }}</small>
                        ...
                        <!--end col-->
                    @endforeach
                    @foreach ($artikels_req as $artikel)
                        <div class="myartikel-req col-lg-4 col-md-6 col-12 mt-4 pt-2 picture-item"
                            data-groups='["{{ $artikel->id_user }}"]' hidden>
                            <div
                                class="card blog border-0 work-container work-primary work-classic shadow rounded-md overflow-hidden">
                                <div class="position-relative">
                                ...
                                <div class="author">
                                    <small class="badge badge-link bg-warning">Request</small>
                                    <small class="text-light user d-block"><i class="uil uil-user"></i>
                                        {{ $artikel->nama_pegawai }}</small>
                                    <small class="text-light date"><i class="uil uil-calendar-alt"></i>
                                        {{ $artikel->publish_at }}</small>
    ...
    @else
        <section class="section">
            <div class="container">
                <div class="row">
                    @foreach ($artikels_public as $artikel)
