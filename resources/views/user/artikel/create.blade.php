            ...
            <div class="position-breadcrumb">
                <nav aria-label="breadcrumb" class="d-inline-block">
                    <ul class="breadcrumb bg-white rounded shadow mb-0 px-4 py-2">
                        ...
                        <li class="breadcrumb-item text-primary">Add Artikel</li>
                    </ul>
                </nav>
            </div>
        </div>
    ...
    <div class="container" style="margin-top: 100px">
        <div class="row justify-content-center">
            <div class="col-lg-12 col-md-10">
                <h3 class="mb-4 text-primary">Add Artikel</h4>
                    <form action="{{ route('artikeluser.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group mb-3">
                            <label class="form-label" style="color:black" for="lampiran_artikel" class="form-label custom-file-input">Lampiran</label>
                        ...
                        <div class="card-body p-0">
                            <form method="post" name="myForm" onsubmit="return validateForm()">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label" class="form-label" style="font-size: 16px">Your Name <span
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label" class="form-label" style="font-size: 16px">Your Email <span
                                                    class="text-danger">*</span></label>
                                            <div class="form-icon position-relative">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            <label class="form-label" class="form-label" style="font-size: 16px">Subject</label>
                                            <div class="form-icon position-relative">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            <label class="form-label" class="form-label" style="font-size: 16px">Comments <span
                                                    class="text-danger">*</span></label>
                                            <div class="form-icon position-relative">
