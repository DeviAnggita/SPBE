    ...
    <header id="topnav" class="defaultscroll sticky">
        <div class="container">
            ...
            <a class="logo" href="{{ route('home.index') }}">
                ...
                <img src="../../assets/user/images/logo-light.png" height="24" class="logo-dark-mode"
                    alt="">
            </a>
            ...
            <div class="position-breadcrumb">
                <nav aria-label="breadcrumb" class="d-inline-block">
                    <ul class="breadcrumb bg-white rounded shadow mb-0 px-4 py-2">
                        ...
                        <li class="breadcrumb-item text-primary">Edit Kegiatan</li>
                    </ul>
                </nav>
            </div>
        </div>
    ...
    <div class="container" style="margin-top: 100px">
        <div class="row justify-content-center">
            <div class="col-lg-12 col-md-10">
                <h3 class="mb-4 text-primary">Edit Kegiatan</h4>
                    <div class="d-flex">
                        <h5 class="me-2">Author</h5>
                        <h5 class="me-2">:</h5>
                        <h5>{{ $pegawai->nama_pegawai }}</h5>
                    </div>
                    <form action="{{ route('kegiatanuser.update', $kegiatan->id_kegiatan) }}" method="POST"
                        enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="form-group mb-3" hidden>
                            <label class="form-label" style="font-size: 16px" for="">Id Kegiatan</label>
                            <input type="text" class="form-control @error('id_kegiatan') is-invalid @enderror"
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control @error('latar_belakang_kegiatan') is-invalid @enderror" name="latar_belakang_kegiatan"
                                id="latarbelakangkegiatan" rows="3">{{ $kegiatan->latar_belakang_kegiatan }}</textarea>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control @error('deskripsi_kegiatan') is-invalid @enderror" name="deskripsi_kegiatan"
                                id="deskripsikegiatan" rows="3">{{ $kegiatan->deskripsi_kegiatan }}</textarea>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control @error('tujuan_kegiatan') is-invalid @enderror" name="tujuan_kegiatan"
                                id="tujuankegiatan" rows="3">{{ $kegiatan->tujuan_kegiatan }}</textarea>
                        ...
                        <div class="form-group mb-3">
                            <label style="font-size: 16px" class="form-label" for="exampleInputdatetime">Tanggal
                                Publish</label>
                            <input type="datetime-local" class="form-control" name="publish_at" id="publish_at"
                                value="{{ $kegiatan->publish_at }}">
                            @error('publish_at')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group mb-3">
                            <label style="font-size: 16px" for="Lampiran"
                                class="form-label custom-file-input">Lampiran</label>
                            <input class="form-control @error('lampiran_kegiatan') is-invalid @enderror" type="file"
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control @error('cover') is-invalid @enderror" type="file"
                                name="cover" id="cover" value="{{ $kegiatan->cover }}">
                            @error('cover')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
                        <ul class="list-unstyled text-sm-end mb-0">
                            ...
                            <li class="list-inline-item"><a href="javascript:void(0)"><img
                                        src="../assets/user/images/payments/discover.png"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label" style="font-size: 16px" class="form-label"
                                                style="font-size: 16px" class="form-label" style="font-size: 16px"
                                                style="font-size: 16px">Your Name <span
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label" style="font-size: 16px" class="form-label"
                                                style="font-size: 16px" class="form-label" style="font-size: 16px"
                                                style="font-size: 16px">Your Email <span
                                                    class="text-danger">*</span></label>
                                            <div class="form-icon position-relative">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            <label class="form-label" style="font-size: 16px" class="form-label"
                                                style="font-size: 16px" class="form-label" style="font-size: 16px"
                                                style="font-size: 16px">Subject</label>
                                            <div class="form-icon position-relative">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            <label class="form-label" style="font-size: 16px" class="form-label"
                                                style="font-size: 16px" class="form-label" style="font-size: 16px"
                                                style="font-size: 16px">Comments <span
                                                    class="text-danger">*</span></label>
                                            <div class="form-icon position-relative">
