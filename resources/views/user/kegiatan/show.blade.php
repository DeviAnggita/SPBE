            ...
            <div class="position-breadcrumb">
                <nav aria-label="breadcrumb" class="d-inline-block">
                    <ul class="breadcrumb bg-white rounded shadow mb-0 px-4 py-2">
                        ...
                        <li class="breadcrumb-item text-primary">Detail Kegiatan</li>
                    </ul>
                </nav>
            </div>
        </div>
            ...
            <div class="col-lg-8 col-md-10">
                <div class="section-title">
                    <div class="text-center">
                        <h4 class="title mb-4">{{ $kegiatan->judul_kegiatan }}</h4>
                        @if ($member == true)
                            <div class="button-action">
                                <a href="{{ route('kegiatanuser.edit', $kegiatan->id_kegiatan) }}"
                                    class="btn btn-icon btn-pills btn-outline-primary" data-bs-toggle="tooltip"
                                    title="Edit Kegiatan"><i data-feather="edit" class="fea icon-sm"></i></a>
                                <button onclick="handleDeleteKegiatan('{{ $kegiatan->id_kegiatan }}', '{{ $inovasi->id_inovasi }}')"
                                    class="btn btn-icon btn-pills btn-outline-danger" data-bs-toggle="tooltip"
                                    title="Delete Kegiatan"><i data-feather="trash" class="fea icon-sm"></i>
                                </button>
                                <div class="modal fade" id="deletekegiatan" data-bs-backdrop="static"
                                    ...
                                    aria-hidden="true">
                                    <form action="{{ route('kegiatanuser.delete') }}" method="post">
                                        @csrf
                        ...
                        <ul class="list-unstyled d-flex justify-content-between" style="margin-top: 60px">
                            <li class="list-inline-item user me-2"><a href="javascript:void(0)" class="text-muted"><i
                                        class="uil uil-user text-dark"></i> {{ $kegiatan->nama_pegawai }}</a></li>
                            <li class="list-inline-item date text-muted"><i
                                    class="uil uil-calendar-alt text-dark"></i> {{ $kegiatan->publish_at }}</li>
                        </ul>
                        <img src="../assets/user/images/blog/01.jpg" class="img-fluid rounded-md shadow-md"
                            alt="">
                    </div>
                    ...
                    <div class="text-muted d-flex">
                        <i class="uil uil-file-alt text-dark mb-5" style="font-size: 20px"></i>
                        <div class="ms-2" style="font-size: 15px; margin-top: 3px">
