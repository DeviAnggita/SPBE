...
<body>
            ...
            <div class="row mt-5 justify-content-center">
                <div class="col-lg-8 text-center">
                    <div class="pages-heading">
                        <h4 class="title mb-2"> Inovasi </h4>
            ...
            <div class="position-breadcrumb">
                <nav aria-label="breadcrumb" class="d-inline-block">
                    <ul class="breadcrumb bg-white rounded shadow mb-0 px-4 py-2">
                        ...
                        <li class="breadcrumb-item text-primary">Edit Inovasi</li>
                    </ul>
                </nav>
            </div>
        </div>
    ...
    <div class="container" style="margin-top: 100px">
        <div class="row justify-content-center">
            <div class="col-lg-12 col-md-10">
                <h3 class="mb-4 text-primary">Edit Inovasi</h4>
                    <form action="{{ route('inovasiuser.update', $inovasi->id_inovasi) }}" method="POST"
                        ...
                        <input type="text" class="form-control @error('id_inovasi') is-invalid @enderror"
                            ...
                            value="{{ $inovasi->id_inovasi }}" required hidden>
                        <div class="form-group mb-3">
                            <label class="form-label" style="font-size: 16px" for="">Judul Inovasi</label>
                            <input type="text"
                                class="form-control @error('judul_inovasi') is-invalid @enderror"
                                name="judul_inovasi" id="judul_inovasi"
                                value="{{ $inovasi->judul_inovasi }}" aria-describedby="helpId"
                                placeholder="">
                            @error('judul_inovasi')
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control @error('latar_belakang') is-invalid @enderror"
                                name="latar_belakang" id="latarbelakanginovasi"
                                rows="3">{{ $inovasi->latar_belakang }}</textarea>
                        ...
                        <div class="form-group mb-3">
                            <label class="form-label" style="font-size: 16px" for="">Deskripsi Inovasi</label>
                            <textarea class="form-control @error('deskripsi_inovasi') is-invalid @enderror"
                                name="deskripsi_inovasi" id="deskripsiinovasi"
                                rows="3">{{ $inovasi->deskripsi_inovasi }}</textarea>
                            @error('deskripsi_inovasi')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                            @enderror
                        ...
                        <div class="form-group mb-3">
                            <label class="form-label" style="font-size: 16px" for="">Tujuan Inovasi</label>
                            <textarea class="form-control @error('tujuan_inovasi') is-invalid @enderror"
                                name="tujuan_inovasi" id="tujuaninovasi"
                                rows="3">{{ $inovasi->tujuan_inovasi }}</textarea>
                        ...
                        <div class="form-group mb-3">
                            <label class="form-label" style="font-size: 16px" class="form-label">Kategori Inovasi</label>
                            <select name="kategori_inovasi" class="form-select mb-3 shadow-none" required>
                                <option disabled selected="">Pilih Kategori</option>
                                <option value="Aplikasi"
                                    {{ $inovasi->kategori_inovasi == "Aplikasi" ? "selected" : "" }}>
                                    Aplikasi</option>
                                <option value="Infrastruktur"
                                    {{ $inovasi->kategori_inovasi == "Infrastruktur" ? "selected" : "" }}>
                                    Infrastruktur</option>
                                <option value="Keamanan"
                                    {{ $inovasi->kategori_inovasi == "Keamanan" ? "selected" : "" }}>
                                    Keamanan</option>
                            </select>
                            @error('kategori_inovasi')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                            @enderror
                        ...
                        <div class="form-group mb-3">
                            <label class="form-label" style="font-size: 16px" class="form-label" for="exampleInputdatetime">Tanggal Publish</label>
                            <input type="datetime-local" class="form-control @error('publish_at') is-invalid @enderror" name="publish_at" id="publish_at" value="{{ $inovasi->publish_at }}">
                            @error('publish_at')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="form-group mb-3">
                            <label class="form-label" style="font-size: 16px" for="Lampiran" class="form-label custom-file-input">Lampiran</label>
                            <input class="form-control @error('lampiran_inovasi') is-invalid @enderror"
                                type="file" name="lampiran_inovasi" id="lampiran_inovasi"
                                value="{{ $inovasi->lampiran_inovasi }}">
                            @error('lampiran_inovasi')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                            @enderror
                        ...
                        <div class="form-group mb-3">
                            <label class="form-label" style="font-size: 16px" for="cover" class="form-label custom-file-input">Cover</label>
                            <input class="form-control @error('cover') is-invalid @enderror"
                                type="file" name="cover" id="cover" value="{{ $inovasi->cover }}">
                            @error('cover')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="card-body p-0">
                            <form method="post" name="myForm" onsubmit="return validateForm()">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label" style="font-size: 16px" class="form-label" style="font-size: 16px">Your Name <span
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label" style="font-size: 16px" class="form-label" style="font-size: 16px">Your Email <span
                                                    class="text-danger">*</span></label>
                                            <div class="form-icon position-relative">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            <label class="form-label" style="font-size: 16px" class="form-label" style="font-size: 16px">Subject</label>
                                            <div class="form-icon position-relative">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            <label class="form-label" style="font-size: 16px" class="form-label" style="font-size: 16px">Comments <span
                                                    class="text-danger">*</span></label>
                                            <div class="form-icon position-relative">
    ...
    <script type="text/javascript">
        CKEDITOR.replace('latarbelakanginovasi');
        CKEDITOR.replace('deskripsiinovasi');
        CKEDITOR.replace('tujuaninovasi');
    </script>
