            ...
            <div class="position-breadcrumb">
                <nav aria-label="breadcrumb" class="d-inline-block">
                    <ul class="breadcrumb bg-white rounded shadow mb-0 px-4 py-2">
                        ...
                        <li class="breadcrumb-item text-primary">Add Inovasi</li>
                    </ul>
                </nav>
            </div>
        </div>
    ...
    <div class="container" style="margin-top: 100px">
        <div class="row justify-content-center">
            <div class="col-lg-12 col-md-10">
                <h3 class="mb-4 text-primary">Add Inovasi</h4>
                    <form action="{{ route('inovasiuser.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="id_user" value="{{ Auth::user()->id_user }}">
                        <div class="form-group mb-3">
                            <label class="form-label" style="font-size: 16px" for="">Judul Inovasi</label>
                            <input type="text" class="form-control @error('judul_inovasi') is-invalid @enderror"
                                name="judul_inovasi" id="judul_inovasi" aria-describedby="helpId" placeholder="">
                            @error('judul_inovasi')
                        ...
                        <div class="form-group mb-3">
                            <label class="form-label" style="font-size: 16px" class="form-label">Kategori
                                Inovasi</label>
                        ...
                        <div class="form-group mb-3">
                            <label class="form-label" style="font-size: 16px" class="form-label"
                                for="exampleInputdatetime">Tanggal
                                Publish</label>
                            <input type="datetime-local"
                                class="form-control  @error('publish_at') is-invalid @enderror" name="publish_at"
                                id="publish_at">
                            @error('publish_at')
                                <div class="invalid-feedback">
                                    {{ $message }}
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control @error('lampiran_inovasi') is-invalid @enderror" type="file"
                                name="lampiran_inovasi" id="lampiran_inovasi">
                        ...
                        <div class="card-body p-0">
                            <form method="post" name="myForm" onsubmit="return validateForm()">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label" style="font-size: 16px">Your Name <span
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label" style="font-size: 16px">Your Email <span
                                                    class="text-danger">*</span></label>
                                            <div class="form-icon position-relative">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            <label class="form-label" style="font-size: 16px">Subject</label>
                                            <div class="form-icon position-relative">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            <label class="form-label" style="font-size: 16px">Comments <span
                                                    class="text-danger">*</span></label>
                                            <div class="form-icon position-relative">
