            ...
            <div class="position-breadcrumb">
                <nav aria-label="breadcrumb" class="d-inline-block">
                    <ul class="breadcrumb bg-white rounded shadow mb-0 px-4 py-2">
                        ...
                        <li class="breadcrumb-item text-primary">Detail inovasi</li>
                    </ul>
                </nav>
            </div>
        </div>
            ...
            <div class="col-lg-8 col-md-10">
                <div class="section-title">
                    <div class="text-center">
                        <h5 class="text-primary">{{ $inovasi->kategori_inovasi }}</h5>
                        <h4 class="title mb-4">{{ $inovasi->judul_inovasi }}</h4>
                        @if ($member == null)
                            <div></div>
                        @elseif ($member->keterangan == 'Owner')
                            <div class="button-action">
                                <a href="{{ route('membersuser.show', $inovasi->id_inovasi) }}"
                                    class="btn btn-icon btn-pills btn-outline-success" data-bs-toggle="tooltip"
                                    title="Members"><i data-feather="user-plus" class="fea icon-sm"></i></a>
                                <a href="{{ route('inovasiuser.edit', $inovasi->id_inovasi) }}"
                                    class="btn btn-icon btn-pills btn-outline-primary" data-bs-toggle="tooltip"
                                    title="Edit Inovasi"><i data-feather="edit" class="fea icon-sm"></i></a>
                                <button onclick="handleDeleteInovasi('{{ $inovasi->id_inovasi }}')"
                                    class="btn btn-icon btn-pills btn-outline-danger" data-bs-toggle="tooltip"
                                    title="Delete Inovasi"><i data-feather="trash" class="fea icon-sm"></i>
                                </button>
                                <div class="modal fade" id="deleteinovasi" data-bs-backdrop="static"
                                    data-bs-keyboard="false" tabindex="-1" aria-labelledby="editinovasiLabel"
                                    aria-hidden="true">
                                    <form action="{{ route('inovasiuser.delete') }}" method="post">
                                        @csrf
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body" style="text-align: center;">
                                                    <h3 class="judul mb-3">Delete Inovasi</h3>
                                                    <input type="text"
                        ...
                        @endif
                        <ul class="list-unstyled d-flex justify-content-between" style="margin-top: 60px">
                            <li class="list-inline-item user me-2"><a href="javascript:void(0)" class="text-muted"><i
                                        class="uil uil-user text-dark"></i> {{ $inovasi->nama_pegawai }}</a></li>
                            <li class="list-inline-item date text-muted"><i
                                    class="uil uil-calendar-alt text-dark"></i> {{ $inovasi->publish_at }}</li>
                        </ul>
                        <img src="../assets/cover/{{ $inovasi->cover }}" class="img-fluid rounded-md shadow-md"
                            alt="">
                    </div>
                    ...
                    <h4 class="my-4">Tujuan</h4>
                    <div class="text-muted">
                        {!! $inovasi->tujuan_inovasi !!}
                    </div>

                    <h4 class="my-4">Lampiran</h4>
                    <div class="text-muted d-flex">
                        <i class="uil uil-file-alt text-dark" style="font-size: 20px"></i>
                        <div class="ms-2" style="font-size: 15px; margin-top: 3px"><a href="{{ route('inovasiuser.download', $inovasi->lampiran_inovasi) }}">
                            {{ $inovasi->lampiran_inovasi }}</a>
                        </div>
                    </div>
                    ...
                    <div class="d-flex mt-4">
                        ...
                        @if ($member == true)
                            <div class="col text-end">
                                <a href="{{ route('kegiatanuser.create', $inovasi->id_inovasi) }}"
                                    data-bs-toggle="tooltip" title="Add Kegiatan" class="btn btn-icon btn-primary"><i
                                        data-feather="plus" class="fea icon-sm"></i></a>
                            </div>
                        @endif
                    </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                                    <div
                                        ...
                                        <div class="card-body p-0">
                                            <a href="{{ route('kegiatanuser.show', $kegiatan->id_kegiatan) }}"
                                                class="lightbox d-inline-block tobii-zoom" title="">
                                                <img src="../assets/user/images/blog/01.jpg" class="img-fluid"
                                                    alt="work-image">
                                                <div class="tobii-zoom__icon"><svg xmlns="http://www.w3.org/2000/svg"
                                                        viewBox="0 0 24 24" aria-hidden="true" focusable="false">
                                                        <path stroke="none" d="M0 0h24v24H0z"></path>
                                                        <polyline points="16 4 20 4 20 8"></polyline>
                                                        <line x1="14" y1="10" x2="20"
                                                            y2="4">
                                                        </line>
                                                        <polyline points="8 20 4 20 4 16"></polyline>
                                                        <line x1="4" y1="20" x2="10"
                                                            y2="14">
                                                        </line>
                                                        <polyline points="16 20 20 20 20 16"></polyline>
                                                        <line x1="14" y1="14" x2="20"
                                                            y2="20">
                                                        </line>
                                                        <polyline points="8 4 4 4 4 8"></polyline>
                                                        <line x1="4" y1="4" x2="10"
                                                            y2="10">
                                                        </line>
                                                    </svg></div>
                                            </a>
                                            <div class="content bg-white p-3">
                                                <h6 class="mb-0"><a
                                                        href="{{ route('kegiatanuser.show', $kegiatan->id_kegiatan) }}"
                                                        class="text-dark">{{ $kegiatan->judul_kegiatan }}</a></h6>
                                                <p class="text-muted mb-0"><i
                                                        class="uil uil-calendar-alt text-dark"></i>
                                                    {{ $kegiatan->publish_at }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
