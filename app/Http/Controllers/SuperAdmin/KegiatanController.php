...
class KegiatanController extends Controller
{
    ...
    public function viewLampiran($id_kegiatan)
    {
        ...
        return view('superadmin/kegiatan.image', compact('kegiatan'));
    }
    ...
    public function add($id_inovasi)
    {
        ...
        $akun = DB::table('users')
            ...
            ->where('id_user', Auth::user()->id_user)
            ->first();
        return view('superadmin/kegiatan.create', compact('inovasi', 'pegawais', 'akun'));
    }
    ...
    public function show($id_kegiatan)
    {
        ...
        $akun = DB::table('users')
            ...
            ->where('id_user', Auth::user()->id_user)
            ->first();
        return view('superadmin/kegiatan.show', compact('kegiatan', 'inovasi', 'akun'));
    }
    ...
    public function edit($id_kegiatan)
    {
        ...
        $akun = DB::table('users')
            ...
            ->where('id_user', Auth::user()->id_user)
            ->first();
        return view('superadmin/kegiatan.edit', compact('kegiatan', 'pegawais', 'akun'));
    }
