...
class InovasiPegawaiAdminController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($idPegawai == true) {
            return redirect()
                ->route('membersadmin.show', [$request->id_inovasi])
                ->with([
    ...
    public function show($id_inovasi)
    {
        ...
        ->where('id_user', Auth::user()->id_user)
        ->first();
        return view('admin/inovasipegawai.show', compact('inovasis', 'owner', 'pegawais', 'members', 'akun'));
    }
    ...
    public function mystore(Request $request)
    {
        ...
        if ($idPegawai == true) {
            return redirect()
                ->route('membersadmin.myshow', [$request->id_inovasi])
                ->with([
                    Alert::error('Gagal', 'Member Sudah Ada')
                ]);
        } else {
    ...
    public function myshow($id_inovasi)
    {
        $inovasis = DB::table('tb_inovasi')
            ->join('tb_inovasi_pegawai', 'tb_inovasi.id_inovasi', '=', 'tb_inovasi_pegawai.id_inovasi')
            ->join('users', 'tb_inovasi_pegawai.id_user', '=', 'users.id_user')
        ...
        ->where('id_user', Auth::user()->id_user)
        ->first();
        return view('admin/inovasipegawai.myshow', compact('inovasis', 'owner', 'pegawais', 'members', 'akun'));
    }
